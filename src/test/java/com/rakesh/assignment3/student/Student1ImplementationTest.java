...
public class Student1ImplementationTest {
    public static List<Student1> list = StudentDataBase.getAllStudents();
    ...
    public void nameCheck() {
        ...
        List<Student1> emptyStudent1 = new ArrayList<>();
        Assert.assertEquals(expectedList1, StudentImplementation.getNames(emptyStudent1));
    }
