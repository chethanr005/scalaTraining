        ...
        Supplier<List<Employee>> getALlEmpData = () -> {
            ...
            try {
                ...
                while (rst.next()) {
                    ...
                    result.add(new Employee(rst.getInt("EmpID"), rst.getString("Name"), rst.getString("Department")
        ...
        Supplier<Employee> getEmployee = () ->
        {
            ...
            try {
                ...
                if (rst.next()) {
                    LocalDate joiningDate = LocalDate.parse(rst.getString("JoingDate"));
                    LocalDate dob         = LocalDate.parse(rst.getString("DOB"));
                    result = new Employee(rst.getInt("EmpID"), rst.getString("Name"), rst.getString("Department")
                            , rst.getDouble("Salary"), rst.getString("Gender"), joiningDate, dob, rst.getString("JobLevel"));
                }
            } catch (Exception e) {
                System.out.println(e.getMessage());
