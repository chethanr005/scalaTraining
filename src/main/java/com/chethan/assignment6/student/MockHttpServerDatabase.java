...
public class MockHttpServerDatabase {
    ...
    public String addExpectedStudent() {
        return "{\"activities\":[\"walking\",\"cycling\"],\"gender\":\"female\",\"gpa\":5.0,\"gradeLevel\":9,\"id\":\"r011\",\"name\":\"me\"}";
    }

    public String getFilteredStudent(){
    return "[{\"activities\":[\"hiking\",\"running\"],\"gender\":\"female\",\"gpa\":7.0,\"gradeLevel\":9,\"id\":\"r002\",\"name\":\"julie\"}]";    }
